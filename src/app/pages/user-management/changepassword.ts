...
export class NewPassword {
  ...
  constructor(private autherService:AuthService, private profileService: ProfileService,private messageService: MessageService){}
...
changePassword(data:any){
  const userName= this.autherService.isLogIntType();
...
this.profileService.onChangePasswordUpsert(payload).subscribe({
  next:(res)=>{
